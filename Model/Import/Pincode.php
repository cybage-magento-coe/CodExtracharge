...
namespace Cybage\CodExtracharge\Model\Import;

use Cybage\CodExtracharge\Model\Import\Pincode\RowValidatorInterface as ValidatorInterface;
...
class Pincode extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{
    ...
    const TABLE_Entity = 'cybage_pincodechecker';
    ...
    protected function saveAndReplaceEntity()
    {
        ...
        while ($bunch = $this->_dataSourceModel->getNextBunch()) {
            ...
            if (\Magento\ImportExport\Model\Import::BEHAVIOR_REPLACE == $behavior) {
                if ($listpincode) {
                    if ($this->deleteEntityFinish(array_unique(  $listpincode), self::TABLE_Entity)) {
