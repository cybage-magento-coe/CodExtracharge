...
class Pincode extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
     ...
     * @param \Cybage\CodExtracharge\Model\PincodecheckerFactory $pincodeCollection
    ...
    public function __construct(
        ...
        \Cybage\CodExtracharge\Model\PincodecheckerFactory $pincodeCollection,
    ...
    public function getPincodeStatus($pincode)
    {
        ...
        $collection = $this->pincodeCollection->create()->getCollection();
