...
class Edit extends \Cybage\CodExtracharge\Controller\Adminhtml\Pincodechecker
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Cybage\CodExtracharge\Model\Pincodechecker');
        ...
        $this->_coreRegistry->register('cyb_codextracharge_pincodechecker', $model);
