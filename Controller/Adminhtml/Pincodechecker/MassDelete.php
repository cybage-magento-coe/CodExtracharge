...
class MassDelete extends \Magento\Backend\App\Action {
    ...
    public function __construct(
        ...
        \Cybage\CodExtracharge\Model\ResourceModel\Pincodechecker\CollectionFactory $collectionFactory,
    ...
    public function execute() {
        ...
        return $resultRedirect->setPath('cyb_codextracharge/pincodechecker');
    }
