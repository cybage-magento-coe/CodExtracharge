...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Cybage\CodExtracharge\Model\Pincodechecker')->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('cybage_codextracharge_pincodechecker_pincodechecker');
            ...
            $this->dataPersistor->set('cyb_codextracharge_pincodechecker', $data);
